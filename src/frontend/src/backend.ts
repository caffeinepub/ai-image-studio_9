...
import type { ExternalBlob as _ExternalBlob, GenerationRecord as _GenerationRecord, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPrompt(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPrompt(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateImage(arg0: string, arg1: string | null, arg2: Array<ExternalBlob>, arg3: ExternalBlob | null, arg4: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.generateImage(arg0, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg1), await to_candid_vec_n9(this._uploadFile, this._downloadFile, arg2), await to_candid_opt_n11(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGenerationHistory(): Promise<Array<GenerationRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGenerationHistory();
    ...
    async getPrompt(arg0: string): Promise<Prompt> {
        if (this.processError) {
            try {
    ...
    async postGenerateImageAPI(arg0: string, arg1: string, arg2: string | null, arg3: Array<ExternalBlob>): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.postGenerateImageAPI(arg0, arg1, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg2), await to_candid_vec_n9(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_GenerationRecord_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _GenerationRecord): Promise<GenerationRecord> {
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        resultUrl: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.resultUrl)),
        referenceImages: await from_candid_vec_n16(_uploadFile, _downloadFile, value.referenceImages),
        timestamp: value.timestamp,
        resultBlob: record_opt_to_undefined(await from_candid_opt_n18(_uploadFile, _downloadFile, value.resultBlob)),
        prompt: value.prompt,
        negativePrompt: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.negativePrompt))
    };
}
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_GenerationRecord>): Promise<Array<GenerationRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_GenerationRecord_n13(_uploadFile, _downloadFile, x)));
}
